...
public class TagGermlineEventsIntegrationTest extends CommandLineProgramTest {
    ...
    public static final String TAG_GERMLINE_NORMAL_SEG_FILE = TEST_RESOURCE_DIR + "tag-germline-header-normal.tsv";
    public static final String TAG_GERMLINE_TUMOR_MATCHED_NORMAL_SEG_FILE = TEST_RESOURCE_DIR + "tag-germline-tumor-all-match-normal.tsv";
    public static final String TAG_GERMLINE_TUMOR_ALMOST_MATCHED_NORMAL_SEG_FILE = TEST_RESOURCE_DIR + "tag-germline-tumor-some-match-normal.tsv";
    public static final String TAG_GERMLINE_TUMOR_NOT_MATCHED_NORMAL_SEG_FILE = TEST_RESOURCE_DIR + "tag-germline-no-match-normal.tsv";
    public static final String TAG_GERMLINE_TUMOR_SPLIT_ALMOST_MATCHED_NORMAL_SEG_FILE = TEST_RESOURCE_DIR + "tag-germline-tumor-split-some-match-normal.tsv";
    public static final String TAG_GERMLINE_TUMOR_SPLIT_NO_MATCHED_NORMAL_SEG_FILE = TEST_RESOURCE_DIR + "tag-germline-tumor-split-no-match-normal.tsv";
